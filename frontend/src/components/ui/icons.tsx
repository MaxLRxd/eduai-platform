...
const PATHS: Record<IconKey, React.ReactNode> = {
  ...
  appearance: (
    <>
      <circle cx="12" cy="12" r="10" />
      <path d="M12 2a10 10 0 000 20c1.7 0 3-.9 3-2 0-.5-.2-1-.5-1.4-.3-.4-.5-.8-.5-1.3 0-1.1.9-2 2-2h2.5a5.5 5.5 0 000-11 10 10 0 00-6.5 2.4" />
  ...
  analytics: (
    <>
      ...
      <polyline points="7 10 10 7 13 10 16 6" />
    </>
  ),
  content: (
    <>
...
export function Icon({ name, className = "w-4 h-4" }: { name: IconKey; className?: string }): React.ReactElement {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
